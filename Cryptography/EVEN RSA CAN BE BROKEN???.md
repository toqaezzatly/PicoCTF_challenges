...
Congratulations! You’ve successfully captured the flag. 🚩 

Here is a clear, simple writeup that explains the challenge, the logic behind the solution, and the terms you asked about.
...
### **Summary**
The challenge was a "sanity check" for RSA. It teaches you that **$N$ must always be a product of two large, odd primes**. If $N$ is even, the encryption is broken instantly because it becomes trivial to factor.
